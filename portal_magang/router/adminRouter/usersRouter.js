...
router.post("/account", verifyUser, adminOnly, [
      // ----- EMAIL VALIDATION ----- //
...
router.put("/account/:id", verifyUser, adminOnly, [
      // ----- EMAIL VALIDATION ----- //
...
router.put("/account/profile/:id", verifyUser, adminOnly, fileUpload, [
      // ----- EMAIL VALIDATION ----- //
...
router.put("/change-pass/:id", verifyUser, adminOnly, [
