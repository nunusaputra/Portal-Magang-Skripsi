...
const EditLowongan = () => {
  ...
  const updateLowongan = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`http://localhost:5000/mitra/job/${id}`, {
        jobTitle: jobTitle,
        jobType: jobType,
        maxPositions: maxPos,
        duration: duration,
      ...
      toast.success("Berhasil Merubah Informasi");
  ...
  useEffect(() => {
    const getInfoById = async () => {
      try {
        ...
        setMaxCan(response.data.data.maxCandidates);
        setMaxApp(response.data.data.acceptedCandidates);
        setDesc(response.data.data.desc);
        setSalary(response.data.data.salary);
        setSkillSets(response.data.data.skillSet);
                ...
                <div className="space-y-12">
                  <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                      Mitra dapat mendedit lowongan magang yang sudah dibuat
                      sebelumnya.
                    </p>
